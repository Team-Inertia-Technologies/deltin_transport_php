...
sql_query("INSERT INTO booking_log (iLogID, iFleet_BookingID, cRefType, vRefName, dtAdded, iUserID, cStatus) VALUES ($log_id, '$booking_id', 'G', 'Guest Picked Up', '$NOW', '$driverID', 'A')", 'TRIP.LOG');
