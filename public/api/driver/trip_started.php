...
sql_query("INSERT INTO booking_log (iLogID, iFleet_BookingID, cRefType, vRefName, dtAdded, iUserID, cStatus) VALUES ($log_id, '$booking_id', 'S', 'Trip started', '$NOW', '$driverID', 'A')", 'TRIP.LOG');
