...
switch ($mode) {
    ...
    case 'VEHICLE_DETAILS':
			...
			if(sql_num_rows($r0)){
				...
				$tripsArr = array();
				$q2 = "SELECT fb.iFleet_BookingID, fb.vPickupLocation, fb.vDropLocation, fb.vName, vc.vName AS vehicleType, vc.iCapacity, fb.vPickupTime, fb.vDropTime, cBookingFor FROM fleet_booking fb JOIN vehicle_category vc ON vc.iVCatID = fb.iVehicleCatID WHERE fb.iVehicleID = $vehiId ORDER BY fb.dFrom DESC";
