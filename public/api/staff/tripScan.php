...
switch ($mode) {
    ...
    case 'SCAN':
        ...
        $reqSql = "SELECT iRequestID FROM request WHERE iStaffID = $user_id AND dPickup= $date AND cStatus='A' LIMIT 1";
        ...
        $updateSql = "
    UPDATE request SET iVehicleID = '{$vehicleID}', dtIn = NOW() WHERE iRequestID = {$requestID} LIMIT 1
";
